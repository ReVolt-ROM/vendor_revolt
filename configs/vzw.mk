...
PRODUCT_COPY_FILES += \
    vendor/revolt/prebuilt/vzw/app/VerizonSSO.apk:system/blobs/vzw/app/VerizonSSO.apk \
    vendor/revolt/prebuilt/vzw/etc/permissions/com.vzw.hardware.ehrpd.xml:system/blobs/vzw/etc/permissions/com.vzw.hardware.ehrpd.xml \
    vendor/revolt/prebuilt/vzw/etc/permissions/com.vzw.hardware.lte.xml:system/blobs/vzw/etc/permissions/com.vzw.hardware.lte.xml \
    vendor/revolt/prebuilt/vzw/etc/permissions/com.vzw.vzwapnlib.xml:system/blobs/vzw/etc/permissions/com.vzw.vzwapnlib.xml \
    vendor/revolt/prebuilt/vzw/lib/libmotricity.so:system/blobs/vzw/lib/libmotricity.so
else
PRODUCT_PACKAGES += \
    VerizonSSO
